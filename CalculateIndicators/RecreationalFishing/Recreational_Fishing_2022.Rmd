...
```{r}
setwd("~/Desktop/NYB Indicators/NYB_Indicators_Calculations/CalculateIndicators/RecreationalFishing/Data")
catch<-read.csv("mrip_estim_catch_year_1981_2022_oct.csv")##NY All Ocean Merged
