...
setwd("/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/CalculateIndicators/Zooplankton/Data")
#ZPD=openxlsx::read.xlsx("L1_EcoMon_Plankton_Data_v3_8.xlsx", sheet='Data')
ZPD <- read.csv("EcoMon_Plankton_Data_v3_8.csv")
...
######REORDER
ZPDb=ZPD[,c(1:14, 290:296, 106:197)] #####CAHNGED 297 to 296 - please double check each year to make sure you are picking the right columns
...
for(col_sep in 54:56){ ###loop over scale 1, scale 2 etc.
  col_sep = 52
  print(col_sep)
...
write.csv(finalTSnyb, file = "Zoops_2023nyb.csv")
