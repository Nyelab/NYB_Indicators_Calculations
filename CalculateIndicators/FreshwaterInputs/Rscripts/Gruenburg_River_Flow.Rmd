...
write.csv(flow, "RiverFlow_DEC_14_2023.csv") #Don't forget to change the name each year!


# daily for comparison with Narrows
gage_id<-"01358000"
  dat<-importDVs(gage_id, code="00060", stat="00003")
  #assign water year values and reformat
  dat$dates<-as.POSIXlt(dat$dates)
  ...
  #remove na vales
  dat<-subset(dat,val!="NA")
  #subset for 2023 overlap
  df <- dat[dat$wyear == 2023, ]
  setwd("~/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023")
  write.csv(df, "RiverFlow_DEC_14_2023_Daily2023.csv") #Don't forget to change the name each year!
```
