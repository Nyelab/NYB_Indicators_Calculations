...
NYB_winter<-gam(surf_salt ~ s(lon,lat, k = 100)  +  year_fac,  data = winter)
...
NYB_spring<-gam(surf_salt ~ s(lon,lat, k = 100)  +  year_fac,  data = spring)
...
NYB_summer<-gam(surf_salt ~ s(lon,lat, k = 100)  +  year_fac,  data = summer)
...
NYB_fall<-gam(surf_salt ~ s(lon,lat, k = 100)  +  year_fac,  data = fall)
...
write.csv(fNYB, "SurfSalt_insitu_Nov_8_2025.csv")
