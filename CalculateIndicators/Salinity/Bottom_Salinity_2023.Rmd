...
NYB_winter<-gam(bot_sal ~ s(lon,lat, k = 100)  +  year_fac,  data = winter)
...
NYB_spring<-gam(bot_sal ~ s(lon,lat, k = 100)  +  year_fac,  data = spring)
...
NYB_summer<-gam(bot_sal ~ s(lon,lat, k = 100)  +  year_fac,  data = summer)
...
NYB_fall<-gam(bot_sal ~ s(lon,lat, k = 100)  +  year_fac,  data = fall)
...
write.csv(fNYB, "BSal_insitu_Dec_29_2023.csv")
