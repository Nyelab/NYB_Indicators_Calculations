...
land<-read.csv("FOSS_landings_2023_commercial.csv")
...
Yearly_Landings[73,4] <- Yearly_Landings[73,3] # Add back in the last years USD as it is the present so we are not accounting fo inflation
setwd("~/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_timeseries_Figures/Timeseries_Files_2023")
write.csv(Yearly_Landings, "Commercial_Landings_2023.csv")
#