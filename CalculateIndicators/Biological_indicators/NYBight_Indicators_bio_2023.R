...
##
## Notes: Final version.
## 2023 Sean Lucey says:
## Note that the spring survey this year was severely truncated due to ship and staffing issues.  
## ---------------------------
...
save(total.biomass.fall, file = 'NYB_biomass_fall_2023.RData')
write.csv(total.biomass.fall, file = "NYB_biomass_fall2023.csv")

save(total.biomass.spring, file = 'NYB_biomass_spring_2023.RData')
write.csv(total.biomass.spring, file = "NYB_biomass_spring_2023.csv")
...
##Output to .csv and .RData
save(NYB.indicators.fall, file = 'NYB_summary.fall_2023.RData')
write.csv(NYB.indicators.fall, file = "NYB_summary.fall_2023.csv")

save(NYB.indicators.spring, file = 'NYB_summary.spring_2023.RData')
write.csv(NYB.indicators.spring, file = "NYB_summary.spring_2023.csv")
...
write.csv(longfin.fall,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/longfin_fall_2023.csv")
write.csv(longfin.spring,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/longfin_spring_2023.csv")
...
write.csv(shortfin.fall,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/shortfin_fall_2023.csv")
write.csv(shortfin.spring,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/shortfin_spring_2023.csv")
...
write.csv(bsb.fall,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/bsb_fall_2023.csv")
write.csv(bsb.spring,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/bsb_spring_2023.csv")
...
write.csv(summerflounder.fall,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/summerflounder_fall_2023.csv")
write.csv(summerflounder.spring,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/summerflounder_spring_2023.csv")
...
write.csv(jonah.fall,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/jonah_fall_2023.csv")
write.csv(jonah.spring,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/jonah_spring_2023.csv")
...
write.csv(amlob.fall,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/amlob_fall_2023.csv")
write.csv(amlob.spring,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/amlob_spring_2023.csv")

# Total trawl biomass
trawl.fall<-total.biomass.fall %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(trawl.fall,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/trawl_fall_2023.csv")

trawl.spring<-total.biomass.spring %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(trawl.spring,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/trawl_spring_2023.csv")
...
north.fall<-north.fall %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(north.fall,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/north_fall_2023.csv")

north.spring<-subset(total.biomass.spring, NORTH.SOUTH == 'N',select = c("YEAR","strat.biomass"))
north.spring<-north.spring %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(north.spring,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/north_spring_2023.csv")

south.fall<-subset(total.biomass.fall, NORTH.SOUTH == 'S',select = c("YEAR","strat.biomass"))
south.fall<-south.fall %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(south.fall,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/south_fall_2023.csv")

south.spring<-subset(total.biomass.spring, NORTH.SOUTH == 'S',select = c("YEAR","strat.biomass"))
south.spring<-south.spring %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(south.spring,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/south_spring_2023.csv")
...
benthic.fall<-benthic.fall %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(benthic.fall,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/benthic_fall_2023.csv")

benthic.spring<-subset(total.biomass.spring, BENTH.PEL == 'Benthic',select = c("YEAR","strat.biomass"))
benthic.spring<-benthic.spring %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(benthic.spring,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/benthic_spring_2023.csv")

pelagic.fall<-subset(total.biomass.fall, BENTH.PEL == 'Pelagic',select = c("YEAR","strat.biomass"))
pelagic.fall<-pelagic.fall %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(pelagic.fall,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/pelagic_fall_2023.csv")

pelagic.spring<-subset(total.biomass.spring, BENTH.PEL == 'Pelagic',select = c("YEAR","strat.biomass"))
pelagic.spring<-pelagic.spring %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(pelagic.spring,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/pelagic_spring_2023.csv")
...
write.csv(avgtl.fall,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/avgtl_fall_2023.csv")

avgtl.spring<-subset(total.biomass.spring, SVSPP != '950')
avgtl.spring<-avgtl.spring %>%
  group_by(YEAR) %>%
  summarise(TL = weighted.mean(TL,strat.biomass))
write.csv(avgtl.spring,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/avgtl_spring_2023.csv")
...
write.csv(avgtemp.fall,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/avgtemp_fall_2023.csv")

avgtemp.spring<-subset(total.biomass.spring, wt_mean_temp != 'NA')
avgtemp.spring<-avgtemp.spring %>%
  group_by(YEAR) %>%
  summarise(wt_mean_temp = weighted.mean(wt_mean_temp,strat.biomass))
write.csv(avgtemp.spring,file = "/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/avgtemp_spring_2023.csv")
...
forage.fall<-forage.fall %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(forage.fall,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/forage_fall_2023.csv")

forage.spring<-subset(total.biomass.spring, NEIEA == 'Forage Fish',select = c("YEAR","strat.biomass"))
forage.spring<-forage.spring %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(forage.spring,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/forage_spring_2023.csv")
...
benthos.fall<-benthos.fall %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(benthos.fall,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/benthos_fall_2023.csv")
...
benthos.spring<-benthos.spring %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(benthos.spring,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/benthos_spring_2023.csv")
...
benthivore.fall<-benthivore.fall %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(benthivore.fall,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/benthivore_fall_2023.csv")
...
benthivore.spring<-benthivore.spring %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(benthivore.spring,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/benthivore_spring_2023.csv")
...
planktivore.fall<-planktivore.fall %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(planktivore.fall,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/planktivore_fall_2023.csv")
...
planktivore.spring<-planktivore.spring %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(planktivore.spring,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/planktivore_spring_2023.csv")
...
piscivore.fall<-piscivore.fall %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(piscivore.fall,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/piscivore_fall_2023.csv")
...
piscivore.spring<-piscivore.spring %>%
  group_by(YEAR) %>%
  summarise(strat.biomass = sum(strat.biomass))
write.csv(piscivore.spring,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/piscivore_spring_2023.csv")
...
write.csv(unique_spp_fall,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/richness_fall_2023.csv")
...
write.csv(unique_spp_spring,file="/Users/nyelab/Desktop/NYB Indicators/NYB_Indicators_Calculations/Final_Timeseries_Figures/Timeseries_Files_2023/richness_spring_2023.csv")
