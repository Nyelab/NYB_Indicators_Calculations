## Figures for Bottom Salinity Seasonally
...
bsal<-read.csv("BSalinity_insitu_Nov_8_2025.csv", header = TRUE)
...
fall = nyb[nyb$season == 'sutumn',] #typo in the csv oops!
...
mn_winter5 = mean(winter$Val_I[winter$Year >= 2013])
...
intercept_w = 33.92923   # look at p2_mod and extract the intercept
...
# find the last 5 years mean
mn_spring5 = mean(spring$Val_I[spring$Year >= 2020])
# what quintile the data is in
mn_spring5 >qspring
...
intercept_sp = 33.64953   # look at p2_mod and extract the intercept
...
intercept_su = 33.2885  # look at p2_mod and extract the intercept
...
# find the last 5 years mean
mn_fall5 = mean(fall$Val_I[fall$Year >= 2021])
# what quintile the data is in
mn_fall5 >qfall
...
intercept_fa = 33.19171   # look at p2_mod and extract the intercept
