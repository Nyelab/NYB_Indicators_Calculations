...
pop<-read.csv("LI_Population2025.csv", header = TRUE)
...
mn_pop5 = mean(c_pop$pop[c_pop$Year >= 2020])
...
intercept = 7314856  # look at p2_mod and extract the intercept
...
ggplot() + 
  ...
  geom_point(data = c_pop[55,], aes(x = Year, y = pop), shape = 17, size =3) + 
