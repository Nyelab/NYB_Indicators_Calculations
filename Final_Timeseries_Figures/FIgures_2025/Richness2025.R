...
ds<-read.csv("richness_spring_2025.csv", header = TRUE)
...
intercept = 50.03509  # look at p2_mod and extract the intercept
...
# fall
ds2<-read.csv("richness_fall_2025.csv", header = TRUE)
...
intercept2 = 53.25    # look at p2_mod and extract the intercept
